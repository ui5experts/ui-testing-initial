sap.ui.define([
    ...
    function getFrameUrl(sHash, sUrlParameters) {
      ...
      if (sHash) {
        ...
        sHash = "#UITesting-display";
      }

      return sUrl + sUrlParameters + sHash;
    }

    return Opa5.extend("ui5experts.ui-testing.test.integration.pages.Common", {
      ...
      getMockServer: function () {
        return new Promise(function (success) {
          Opa5.getWindow().sap.ui.require(["ui5experts/ui-testing/localService/mockserver"], function (mockserver) {
